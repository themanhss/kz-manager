                    ...
                    <div class="col-md-8 left-box">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-8" >
                                    <input id="nameCustomer" disabled name="nameCustomer" type="text" class="form-control customer-name" value="{{$lead->customer->first_name.' '.$lead->customer->last_name}}">
                                    <input id="name" disabled name="name" type="hidden" class="form-control" value="{{ $lead->client_id }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8" >
                                    <select class="form-control" disabled id="source_type" name="source_type">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="email" name="email" disabled type="text" class="form-control" value="{{ $lead->email }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="phone" name="phone" disabled type="text" class="form-control" value="{{ $lead->phone }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea id="message" name="message" disabled type="text" class="form-control" value="{{ $lead->message }}">{{ $lead->message }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" name="date" disabled value="{{$lead->date?date('d/m/Y', strtotime($lead->date)):''}}" class="form-control"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    </div><!-- /.input group -->
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    @if(!empty($lead->product_ids))
                                                        <input type='checkbox' disabled name='product[]'  {{in_array($product->product_id,json_decode($lead->product_ids))? 'checked': ''}} value='{{$product->product_id}}' />
                                                    @else
                                                        <input type='checkbox' disabled name='product[]' value='{{$product->product_id}}' />
                                                    @endif
