...
@section("content")
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="#">Edit Promotion</a></li>
        </ol>
    </section>
    <div class="create-user">
        <div class="col-md-9 col-md-offset-1">
            <form id="promotionForm" class="form-horizontal"
                  action="/admin/promotions/edit/{{$promotion->promotion_id}}" method="post"
                ...
                <fieldset>
                        ...
                        <div class="col-md-6">
                            <div class="input-group date">
                                <input type="text" name="start_date"
                                       value="{{$promotion->start_date?date('d/m/Y', strtotime($promotion->start_date)):''}}"
                        ...
                        <div class="col-md-6">
                            <div class="input-group date">
                                <input type="text" name="end_date"
                                       value="{{$promotion->end_date?date('d/m/Y', strtotime($promotion->end_date)):''}}"
                                       class="form-control"><span class="input-group-addon"><i
                                            class="fa fa-calendar"></i></span>
                            </div><!-- /.input group -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="promotion_key" value="{{$promotion->promotion_key}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <select class="form-control" id="status" name="status">
                                <option value="Finished" {{ $promotion->status == "Finished" ? 'selected' : '' }}>
                                    Finished
                                </option>
                                <option value="Ready to launch" {{ $promotion->status == "Ready to launch" ? 'selected' : '' }}>
                                    Ready to launch
                                </option>
                                <option value="Draft" {{ $promotion->status == "Draft" ? 'selected' : '' }}>Draft
                                </option>
                                <option value="Active" {{ $promotion->status == "Active" ? 'selected' : '' }}>Active
                                </option>
                            </select>
                        </div>
                    </div>
