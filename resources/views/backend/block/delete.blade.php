...
@section("content")
    ...
    <div class="create-user">
        <div class="col-md-9 col-md-offset-1">
            <form id="blogsForm" class="form-horizontal" action="/admin/blocks/{{$block->id}}/delete" method="post" enctype="multipart/form-data">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 text-center">
                            ...
                            <button type="submit" class="btn btn-primary btn-create btn-save btn-sm">Delete</button>
                        </div>
                    </div>
