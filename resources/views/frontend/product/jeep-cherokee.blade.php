...
<div class="ute-page-banner">
    <div class="content cherokee">
        <div class="site-content">
            <div class="text-content">
                <div class="title">
                    JEEP CHEROKEE LIMITED (4x4)
                </div>
                <span class="slogan">Impressive looks backed by big capability</span>
        ...
        <div class="site-content">
            <div class="main-content">
                <div class="ute-illustration">
                    <img src="{{ asset('frontend/images/cherokee-diagram.png')}}" />
                </div>
                <div class="details-list">
                    <div class="item">
                        <span class="ute-atribute">Engine</span>
                        <span class="value">3.0L, V6 Turbo Diesel</span>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <span class="value">8 SP AUTOMATIC</span>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <span class="value">550 Nm @1,800 rpm</span>
                    </div>
                    <div class="item">
                        <span class="ute-atribute">Max Power</span>
                        <span class="value">177 kW @4,000 rpm</span>
                    </div>
                    <div class="item">
                        <span class="ute-atribute">Towing Capacity</span>
                        <span class="value">2,268 kg</span>
                    </div>
                </div>
...
<div class="photo-gallery cherokee">
    <div class="content">
...
<div class="research">
    <div class="site-content">
        ...
        <div class="text-box">
            ...
            Take a look at some of our key insights on the Jeep Grand Cherokee.
        </div>
        <div class="details-box">
            <div class="site-content">
                ...
                <div class="details-info">
                    ...
                    <span class="line"><strong>6</strong> - Green rating (out of 10)</span>
                    <span class="line"><strong>$1,795</strong> - Est. annual fuel cost (18,350km @ $1.30/L)</span>
...
<div class="compare inside-page holden cherokee">
    <div class="site-content">
        ...
        <div class="left price-config">
            ...
            <div class="row full-width">
                ...
                <div class="options" id="options-color">
                    <span class="option active is-single">Bright White</span>
                </div>
            </div>
        </div>
        <div class="right">
