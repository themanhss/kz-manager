...
<div class="ute-page">
    <div class="ute-page-banner">
        <div class="content land-cruiser">
            <div class="site-content">
                <div class="text-content">
                    <div class="title">
                        TOYOTA LAND CRUISER GXL (4x4)
                    </div>
                    <span class="slogan">Go anywhere and take anything</span>
                </div>
            </div>
        </div>
    </div>

    <div class="compare inside-page mitsubishi land-cruiser">
        <div class="site-content">
            ...
            <div class="site-content">
                <div class="main-content">
                    <div class="ute-illustration">
                        <img src="{{ asset('frontend/images/land-cruiser-diagram.png')}}" />
                    </div>
                    <div class="details-list">
                        <div class="item">
                            <span class="ute-atribute">Engine</span>
                            <span class="value">4.5L, V8 Turbo Diesel</span>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <span class="value">650 Nm @1,600 rpm</span>
                        </div>
                        <div class="item">
                            <span class="ute-atribute">Max Power</span>
                            <span class="value">200 kW @3,400 rpm</span>
                        </div>
                        <div class="item">
    ...
    <div class="research">
        <div class="site-content">
            ...
            <div class="text-box">
                ...
                Take a look at some of our key insights on the Toyota Land Cruiser.
            </div>
