...
<div class="ute-page">
    ...
    <div class="compare inside-page mitsubishi kluger">
        <div class="site-content">
            <div class="left price-config">
                ...
                <div class="row full-width">
                    ...
                    <div class="options" id="options-color">
                        <span class="option active is-single">Eclipse Black</span>
                    </div>
                </div>
            </div>
            <div class="right">
            ...
            <div class="site-content">
                <div class="main-content">
                    <div class="ute-illustration">
                        <img src="{{ asset('frontend/images/kluger-diagram.png')}}" />
                    </div>
    ...
    <div class="research">
        <div class="site-content">
            ...
            <div class="text-box">
                ...
                Take a look at some of our key insights on the Toyota Kluger.
            </div>
            <div class="details-box">
                <div class="site-content">
                    ...
                    <div class="details-info">
                        ...
                        <span class="line"><strong>10.2</strong> - Fuel consumption (L/100)</span>
                        <span class="line"><strong>5.5</strong> - Green rating (out of 10)</span>
                        <span class="line"><strong>$2,441</strong> - Est. annual fuel cost (18,350km @ $1.30/L)</span>
