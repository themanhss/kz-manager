...
<div class="ute-page-banner">
    <div class="content commodore">
        <div class="site-content">
            <div class="text-content">
                <div class="title">
                    HOLDEN COMMODORE SV6
                </div>
                <span class="slogan">Power from job to job with ease</span>
    ...
    <div class="specs-details">
        <div class="site-content">
            <div class="main-content">
                <div class="ute-illustration commodore">
                    <img src="{{ asset('frontend/images/commodore-diagram.png')}}" />
                </div>
                <div class="details-list">
                    <div class="item">
                        <span class="ute-atribute">Engine</span>
                        <span class="value">3.6L, V6 Petrol</span>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <span class="value">9.5 litres/100km</span>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <span class="value">350 Nm @2,900 rpm</span>
                    </div>
                    <div class="item">
                        <span class="ute-atribute">Max Power</span>
                        <span class="value">210 kW @6,400 rpm</span>
                    </div>
                    <div class="item">
                        <span class="ute-atribute">Towing Capacity</span>
                        <span class="value">1,600 kg</span>
                    </div>
                </div>
...
<div class="photo-gallery commodore">
    <div class="content">
...
<div class="research">
    <div class="site-content">
        ...
        <div class="text-box">
            ...
            Take a look at some of our key insights on the Holden Commodore.
        </div>
        <div class="details-box">
            <div class="site-content">
                ...
                <div class="details-info">
                    ...
                    <span class="line"><strong>9.5</strong> - Fuel consumption (L/100)</span>
                    <span class="line"><strong>5.5</strong> - Green rating (out of 10)</span>
...
<div class="compare inside-page holden commodore">
    <div class="site-content">
        ...
        <div class="left price-config">
            ...
            <div class="row">
                ...
                <div class="options" id="options-color">
                    <span class="option active">Heron White</span>
                    <span class="option">Red Hot</span>
                </div>
            </div>
        </div>
        <div class="right">
