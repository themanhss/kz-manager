...
<div class="ute-page">
    <div class="ute-page-banner">
        <div class="content toyota">
            <div class="site-content">
                <div class="text-content">
                    <div class="title">
                        Toyota Hilux SR HI-RIDER
                    </div>
                    <span class="slogan">BE READY FOR ANYTHING WITH THE LEGENDARY HILUX</span>
                </div>
            </div>
        </div>
    </div>

    <div class="compare inside-page toyota">
        <div class="site-content">
            <div class="left price-config">
                ...
                <div class="row full-width">
                    ...
                    <div class="options" id="options-color">
                        <span class="option active is-single">Glacier White</span>
                    </div>
                </div>
            </div>
            <div class="right">
                <span class="price ute-price-result" data-attr-product="toyota"></span>
                <div class="info">
                ...
                <span class="save">(Save $3,000 or more on manufacturer RRP)</span>
                ...
                <div class="main-content">
                    ...
                    <div class="details-list">
                        ...
                        <div class="item">
                            ...
                            <span class="value">7.3 litres/100km</span>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <span class="value">420 Nm @1,400 rpm</span>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <span class="value">1,000 kg Payload</span>
                        </div>
                        <div class="item">
    ...
    <div class="research">
        <div class="site-content">
            ...
            <div class="text-box">
                ...
                Take a look at some of our key insights on the Toyota Hilux.
            </div>
            <div class="details-box">
                <div class="site-content">
                    ...
                    <div class="details-info">
                        ...
                        <span class="line"><strong>7.3</strong> - Fuel consumption (L/100)</span>
                        <span class="line"><strong>2.5</strong> - Green rating (out of 5)</span>
                        <span class="line"><strong>$2,288</strong> - Est. annual fuel cost (18,350km @ $1.30/L)</span>
                        <span class="line"><strong>2</strong> - Car security rating (out of 5)</span>
                    </div>
                </div>
            </div>
            <div class="specifications-chart">
