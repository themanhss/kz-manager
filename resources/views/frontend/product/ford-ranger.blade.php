    ...
    <div class="content ford">
        <div class="site-content">
            <div class="text-content">
                <div class="title">
                    Ford Ranger XL 2.2 HI-RIDER (4x2)
                </div>
                <span class="slogan">TAKE CARE OF BUSINESS IN THE BIG-PERFORMING RANGER</span>
            ...
            <div class="main-content">
                ...
                <div class="details-list">
                    ...
                    <div class="item">
                        ...
                        <span class="value">L 5.4m, H 1.8m, W 1.9m</span>
                    </div>
                    <div class="item">
                        <span class="ute-atribute">Fuel Use</span>
                        <span class="value">6.9 litres/100km</span>
                    </div>
                    <div class="item">
                        <span class="ute-atribute">Engine</span>
                        <span class="value">2.2L Diesel Turbo</span>
                    </div>
                    <div class="item">
                        <span class="ute-atribute">Torque</span>
                        <span class="value">385 Nm @1,600 rpm</span>
                    </div>
                    <div class="item">
                        <span class="ute-atribute">Power</span>
                        <span class="value">118 kW @3,200 rpm</span>
                    </div>
                    <div class="item">
                        <span class="ute-atribute">Load Carrying Capacity </span>
                        <span class="value">1,271 kg Payload</span>
                    </div>
                    <div class="item">
...
<div class="photo-gallery ford-ranger">
    <div class="content">
...
<div class="research">
    <div class="site-content">
        ...
        <div class="text-box">
            ...
            Take a look at some of our key insights on the Ford Ranger.
        </div>
        <div class="details-box">
            <div class="site-content">
                ...
                <div class="details-info">
                    ...
                    <span class="line"><strong>6.9</strong> - Fuel consumption (L/100)</span>
                    <span class="line"><strong>2.5</strong> - Green rating (out of 5)</span>
                    <span class="line"><strong>$2,163</strong> - Est. annual fuel cost (18,350km @ $1.30/L)</span>
...
<div class="compare inside-page ford">
    <div class="site-content">
        ...
        <div class="left price-config">
            ...
            <div class="row">
                ...
                <div class="options" id="options-color">
                    <span class="option">Cool White</span>
                    <span class="option active">True Red</span>
                </div>
            </div>
        </div>
        <div class="right">
            <span class="price ute-price-result" data-attr-product="ford"></span>
            <div class="info">
