...
function wp_automatic_admin_scripts() {
	...
	if( 'wp_automatic' == $post_type ){
		...
		wp_enqueue_script('wp_automatic_unifom_script',plugins_url('js/jquery.uniform.min.js',__FILE__));
		wp_enqueue_script('wp_automatic_jqtools_script',plugins_url('js/jquery.tools.js',__FILE__));
		wp_enqueue_script('wp_automatic_main_script',plugins_url('js/main.js',__FILE__));
