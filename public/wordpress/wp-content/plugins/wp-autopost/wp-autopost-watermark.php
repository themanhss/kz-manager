<?php
 ...
 if(@$_POST['saction'] == 'updateOption' || @$_POST['saction'] == 'preview'){
   ...
   if($_POST['saction'] == 'preview'){
     ...
     WP_Autopost_Watermark_apf::genPreviewWaterMark($wm);
     $showPreview=true;
   }
...
?>
  ...
  <h2><?php echo __('Watermark Options','wp-autopost'); ?> <a href="admin.php?page=wp-autopost/wp-autopost-watermark.php&id=new" class="add-new-h2"><?php echo __('Add New','wp-autopost'); ?></a> </h2>
      ...
      <tr style="text-align:center" >
		<td style="vertical-align: middle; text-align:center;">
		   ...
		   <div class="row-actions-visible">
              <a href="admin.php?page=wp-autopost/wp-autopost-watermark.php&id=<?php echo $wm->id; ?>"><?php echo __('Setting','wp-autopost'); ?></a> | <span class="trash"><a class="submitdelete delete" title="delete" href="admin.php?page=wp-autopost/wp-autopost-watermark.php&del=<?php echo $wm->id; ?>" ><?php echo __('Delete'); ?></a></span> 
		   </div>
		</td>
        <td style="vertical-align: middle; text-align:center;">
...
?>
 ...
 <div class="icon32" id="icon-wp-autopost"><br/></div>
  <h2><?php echo __('Watermark Options','wp-autopost'); ?> <a href="admin.php?page=wp-autopost/wp-autopost-watermark.php" class="add-new-h2"><?php echo __('Return','wp-autopost'); ?></a> </h2>
  ...
  <table id="text_type" class="form-table" <?php if($wm_type==1) echo 'style="display:none;"'; ?> >
   ...
   <tr>
    ...
    <?php 
		 $default_fonts = WP_Autopost_Watermark_apf::get_fonts(); 
