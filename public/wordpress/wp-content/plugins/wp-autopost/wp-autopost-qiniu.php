...
<table class="form-table">
  ...
  <?php
       if($Qiniu['domain']!=''&&$Qiniu['bucket']!=''&&$Qiniu['access_key']!=''&&$Qiniu['secret_key']!=''):
		 ...
		 apQiniu_setKeys($Qiniu['access_key'], $Qiniu['secret_key']);      
         list($ret, $err) = apQinniu_upload_to_bucket($Qiniu['bucket'],$upload_image,'wp-autopost-logo.png');
         if ($err !== null) {
		   ...
		   $baseUrl = apQiniu_RS_MakeBaseUrl($Qiniu['domain'], $ret['key']);
