...
if(isset($_POST['test_translate'])&&$_POST['test_translate']!=''){  
  ...
  $response = autopostBaiduTranslator_apf::translate($_POST['src_text'],$_POST['fromLanguage'],$_POST['toLanguage'],$BaiduTransOptions['api_key']);
...
?> 
  ...
  <form action="admin.php?page=wp-autopost/wp-autopost-translator-baidu.php" method="post">
  ...
  <?php endif; ?>
   ...
   <?php if(isset($errMsg)&&$errMsg!=null){ ?>
	...
	<tr>
      <td>
	   <?php echo __('Original Language','wp-autopost'); ?> : <select name="fromLanguage" ><?php $fromLanguage = ($_POST['fromLanguage']!='')?$_POST['fromLanguage']:'en'; echo autopostBaiduTranslator_apf::bulid_lang_options($fromLanguage); ?></select>
	  </td>
	</tr>
	<tr>
      <td>
	...
	<tr>
     <td><?php echo __('Translated into','wp-autopost'); ?> : <select name="toLanguage" ><?php $toLanguage = ($_POST['toLanguage']!='')?$_POST['toLanguage']:'';echo autopostBaiduTranslator_apf::bulid_lang_options($toLanguage); ?></select></td>
	</tr>
   </table>
