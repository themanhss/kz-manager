...
?>
     <tr>
	   ...
	   <td> 
	     <span class="trash"><a class="delete" href="admin.php?page=wp-autopost/wp-autopost-link.php&saction=delete&id=<?php echo $autoLink->id; ?>&p=<?php echo $page; ?>" ><?php echo __('Delete'); ?></a></span>
	   </td>
 	 </tr>
<?php } ?>
    </tbody>
	...
	<table>
	  <tbody id="the-list">         	  
       <tr> 
		 ...
		 <td>
		   <select name="use_tag_link" id="use_tag_link">
             <option value="0" selected="true" ><?php echo __('No'); ?></option>
	   ...
	   <tr>
		 ...
		 <td>
		  <div id="tag_link_attribute" style="display:none;" >
           
		   <input type="checkbox" name="NoFollow"  value="1"  /> <?php echo __('No Follow','wp-autopost'); ?> <a title='<?php echo __('This adds a rel= "nofollow" to the link.','wp-autopost'); ?>'>[?]</a>
           <br/>
		   <input type="checkbox" name="NewWindow"  value="1"  /> <?php echo __('New Window','wp-autopost'); ?> <a title='<?php echo __('This adds a target="_blank" to the link, forcing a new browser window on clicking.','wp-autopost'); ?>'>[?]</a>
           <br/>
           <input type="checkbox" name="FirstMatchOnly"  value="1"  /> <?php echo __('First Match Only','wp-autopost'); ?> <a title='<?php echo __('Only add links on the first matched.','wp-autopost'); ?>'>[?]</a>
           <br/>
		   <input type="checkbox" name="Ignorecase"  value="1"  /> <?php echo __('Ignore Case','wp-autopost'); ?>
		   <br/>
		   <input type="checkbox" name="WholeWord"  value="1"   /> <?php echo __('Match Whole Word','wp-autopost'); ?> <?php if((get_bloginfo('language')=='zh-CN'))echo '(中文请勿勾选)'; ?>
		   <a title='<?php echo __('Match whole word only. For language split by "space", like English or other Latin languages.','wp-autopost'); ?>'>[?]</a>
          </div>
		 </td>
	   </tr>
